...
pipe = ConfigPipeline(
    [
        YamlConfig(
            "./damage_sensor.yaml", config_name="default", config_folder="../config"
        ),
...
# Data dir
data_dir = Path(config.data.folder)
...
trainer.train(
    ...
    save_every=config.ckpt.save_dir,
    save_dir=config.ckpt.save_every
)
